...
If you're currently using SHA-1, migrate to:
- SHA-256 for most use cases
- SHA-384 for enhanced security
- SHA-512 for maximum security requirements

All SHA-2 algorithms (SHA-256, SHA-384, SHA-512) are considered cryptographically secure and are recommended by NIST for current and future applications.