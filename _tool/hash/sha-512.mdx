...
Convert text or file into a SHA-512 hash
...
**SHA-512 (Secure Hash Algorithm 1)**

**Overview:**  
SHA-512 is a cryptographic hash function designed by the NSA and published by NIST in 1995 (FIPS PUB 180-1) as part of the Digital Signature Standard. It was developed as an improvement over SHA-0.
